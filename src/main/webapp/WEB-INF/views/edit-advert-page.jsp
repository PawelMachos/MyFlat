                        ...
                        <sec:authorize access="isAuthenticated()">
                            <form method="post" action="/edit-advert">
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="title" id="title" value="${advert.title}">
                                </div> <br>
                                ...
                                <button class="btn btn-primary" type="submit">Popraw ogłoszenie</button>
                                <a href="/adverts" class="btn btn-secondary">Wróć</a>
